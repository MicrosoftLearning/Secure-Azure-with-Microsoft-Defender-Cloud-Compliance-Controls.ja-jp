...
4. **[仮想ネットワークの作成]** の **[基本]** タブで、次の情報を入力するか選択します。
   ...
   |リソース グループ|「**az-rg-1**」と入力し、**[OK]** を選択します|
   |**インスタンスの詳細**|
...
8. **[サブネットの編集]** テンプレートで、次の情報を入力するか選びます。
   ...
   |---|---|
   |**サブネットの詳細**|
   |サブネット テンプレート|既定の設定の [既定値] のままにします|
   |Name|「**subnet-1**」と入力します|
   |開始アドレス|既定の設定 10.0.0.0 のままにします|
   |サブネットのサイズ|既定の設定 [/24 (256 アドレス)] のままにします。
...
5. **[ネットワーク]** ページで、次の情報を確認または入力します。
   ...
   |パブリック IP|既定の設定である新しいパブリック IP のままにします|
