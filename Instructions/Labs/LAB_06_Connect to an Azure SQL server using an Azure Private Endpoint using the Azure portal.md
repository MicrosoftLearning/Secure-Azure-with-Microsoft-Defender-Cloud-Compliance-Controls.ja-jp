...
11. **[Bastion ホスト]** で **[有効にする]** を選択します。 この情報を入力します。
    
    |設定|値|
    |---|---|
    |要塞名|「**myBastionHost**」と入力します|
    |AzureBastionSubnet アドレス空間|「**10.1.1.0/24**」と入力します。|
    |パブリック IP アドレス|**[新規作成]** を選択します。 **[名前]** に「**My BastionIP**」と入力します。 **[OK]** を選択します。| 
...
8. **[プライベート エンドポイントの作成]** で、次の情報を入力または選択します。
   ...
   |ターゲット サブリソース|**[mysqlserver1a]** を選択します。|
   |**ネットワーク**|
   |仮想ネットワーク|**[myVNet1a]** を選択します。|
   |サブネット|**[mySubnet1a]** を選択します。|
   |**プライベート DNS の統合**|
